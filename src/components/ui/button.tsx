...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-accent text-accent-foreground hover:shadow-glow-hover hover:scale-105 active:scale-100 font-semibold",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90 hover:scale-105 active:scale-100",
        outline:
          "border-2 border-border bg-background hover:bg-accent/10 hover:border-accent hover:scale-105 active:scale-100",
        secondary:
        ...
        playful: "bg-gradient-to-r from-accent to-accent/80 text-accent-foreground hover:shadow-glow-hover hover:scale-105 active:scale-100 font-semibold",
      },
      size: {
        default: "h-10 px-4 py-2",
        sm: "h-8 xs:h-9 rounded-lg px-2 xs:px-3 text-xs xs:text-sm",
